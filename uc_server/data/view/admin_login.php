...
<!--vot-->				<p>驗證碼: <input type="text" name="seccode" class="txt seccode" tabindex="2" id="seccode" value="" /><img src="<?php echo UC_API;?>/admin.php?m=seccode&seccodeauth=<?php echo $seccodeinit;?>&<?php echo rand();?>" class="checkcode" /></p>
