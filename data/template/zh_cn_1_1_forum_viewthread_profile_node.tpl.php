...
?><?php
$return = <<<EOF
<div id="g_up{$post['pid']}_menu" class="tip tip_4" style="display: none;"><div class="tip_horn"></div><div class="tip_c">{$post['authortitle']}, !credits! {$post['credits']}, !thread_groupupgrade! {$post['upgradecredit']} !credits!</div></div>
EOF;
?><?php 
return $return;
}
