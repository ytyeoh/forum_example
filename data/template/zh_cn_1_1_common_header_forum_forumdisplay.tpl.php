...
0
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_common.htm', 1528720839, '1', './data/template/zh_cn_1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/header_qmenu.htm', 1528720839, '1', './data/template/zh_cn_1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
|| checktplrefresh('./template/default/common/header.htm', './template/default/common/pubsearchform.htm', 1528720839, '1', './data/template/zh_cn_1_1_common_header_forum_forumdisplay.tpl.php', './template/default', 'common/header_forum_forumdisplay')
;?>
...
<td class="scbar_txt_td"><input type="text" name="srchtxt" id="scbar_txt" value="!enter_content!" autocomplete="off" x-webkit-speech speech /></td>
