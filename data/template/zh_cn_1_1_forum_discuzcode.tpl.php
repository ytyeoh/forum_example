...
?><?php
$return = <<<EOF
<div class="locked">!post_hide_credits!</div>
{$message}<br /><br />
...
?><?php
$return = <<<EOF
<div class="blockcode"><div id="{$randomid}"><ol><li>{$code}</ol></div><em onclick="copycode($('{$randomid}'));">!discuzcode_copyclipboard!</em></div>
EOF;
?><?php 
return $return;
}
...
?><?php
$return = <<<EOF
<div class="showhide"><h4>!post_hide!</h4>\\1</div>
...
<div class="tip_c">
<!--vot-->					<p>!upload_time!: {$attach['dateline']}</p>
<p>!clicktodownload!</p>

EOF;
 if(!$attach['attachimg'] && $_G['getattachcredits']) { 
$return .= <<<EOF
!attachcredits!: {$_G['getattachcredits']}<br />
EOF;
 } 
$return .= <<<EOF
...
EOF;
 if($attach['readperm']) { 
$return .= <<<EOF
, !readperm!: <strong>{$attach['readperm']}</strong>
EOF;
 } 
$return .= <<<EOF
...
EOF;
 if(!$attach['attachimg'] && $_G['getattachcredits']) { 
$return .= <<<EOF
, !attachcredits!: {$_G['getattachcredits']}
EOF;
 } 
$return .= <<<EOF
</p>
...
!price!: <strong>{$attach['price']} {$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit']}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title']}</strong> &nbsp;[<a href="forum.php?mod=misc&amp;action=viewattachpayments&amp;aid={$attach['aid']}" onclick="showWindow('attachpay', this.href)" target="_blank">!pay_view!</a>]

EOF;
 if(!$attach['payed']) { 
$return .= <<<EOF

&nbsp;[<a href="forum.php?mod=misc&amp;action=attachpay&amp;aid={$attach['aid']}&amp;tid={$attach['tid']}" onclick="showWindow('attachpay', this.href)">!attachment_buy!</a>]
...
<em class="xg1">({$attach['attachsize']}, !downloads!: {$attach['downloads']})</em>
</p>
<div class="tip tip_4" id="aid{$attach['aid']}_menu" style="display: none" disautofocus="true">
<div>
<p>
<a href="forum.php?mod=attachment{$is_archive}&amp;aid={$aidencode}&amp;nothumb=yes" target="_blank">!download!</a>

EOF;
 if(helper_access::check_module('album')) { 
$return .= <<<EOF

&nbsp;<a href="javascript:;" onclick="showWindow(this.id, this.getAttribute('url'), 'get', 0);" id="savephoto_{$attach['aid']}" url="home.php?mod=spacecp&amp;ac=album&amp;op=saveforumphoto&amp;aid={$attach['aid']}&amp;handlekey=savephoto_{$attach['aid']}">!save_to_album!</a>

EOF;
 } if($firstpost && $_G['fid'] && $_G['forum']['picstyle'] && ($_G['forum']['ismoderator'] || $_G['uid'] == $attach['uid'])) { 
$return .= <<<EOF

&nbsp;<a href="forum.php?mod=ajax&amp;action=setthreadcover&amp;aid={$attach['aid']}&amp;fid={$_G['fid']}" onclick="showWindow('setcover{$attach['aid']}', this.href)">!set_cover!</a>
...
<p>
<!--vot-->								<span class="y">!upload_time!: {$attach['dateline']}</span>
...
&nbsp;[<a href="forum.php?mod=misc&amp;action=attachpay&amp;aid={$attach['aid']}&amp;tid={$attach['tid']}" onclick="showWindow('attachpay', this.href)" target="_blank">!attachment_buy!</a>]
...
<br>
<a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href+'&referer='+encodeURIComponent(location));">!guestviewthumb!</a>
</div>
...
<div class="xs0">
<p><strong>{$attach['filename']}</strong> <em class="xg1">({$attach['attachsize']}, !downloads!: {$attach['downloads']})</em></p>
<p>
<a href="forum.php?mod=attachment{$is_archive}&amp;aid={$aidencode}&amp;nothumb=yes" target="_blank">!download!</a>
...
<!--kaaleth-->				<p class="xg1 y">!upload_time!: {$attach['dateline']}</p>
...
<em class="xg1">({$attach['attachsize']}, !downloads!: {$attach['downloads']}
EOF;
 if($attach['price']) { 
$return .= <<<EOF
, !price!: {$attach['price']} {$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit']}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title']}
EOF;
 } 
$return .= <<<EOF
)</em>
...
<div class="tip_c xs0">
<!--kaaleth-->			<p>!upload_time!: {$attach['dateline']}</p>
<p>!clicktodownload!</p>
...
$return .= <<<EOF
<br />!readperm!: {$attach['readperm']}
EOF;
 } } if(!IS_ROBOT) { if(!$guestviewthumb) { if($attach['price']) { 
$return .= <<<EOF

<br />!price!: {$attach['price']} {$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['unit']}{$_G['setting']['extcredits'][$_G['setting']['creditstransextra']['1']]['title']}	&nbsp;<a href="forum.php?mod=misc&amp;action=viewattachpayments&amp;aid={$attach['aid']}" onclick="showWindow('attachpay', this.href)" target="_blank">[!pay_view!]</a>
...
$return .= <<<EOF
<br />!attachcredits!: {$_G['getattachcredits']}
EOF;
 } 
$return .= <<<EOF
