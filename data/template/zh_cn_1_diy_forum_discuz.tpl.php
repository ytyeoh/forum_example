...
<p class="chart z">!index_today!: <em><?php echo $todayposts;?></em><span class="pipe">|</span>!index_yesterday!: <em><?php echo $postdata['0'];?></em><span class="pipe">|</span>!index_posts!: <em><?php echo $posts;?></em><span class="pipe">|</span>!index_members!: <em><?php echo $_G['cache']['userstats']['totalmembers'];?></em><?php if($_G['cache']['userstats']['newsetuser']) { ?><span class="pipe">|</span>!welcome_new_members!: <em><a href="home.php?mod=space&amp;username=<?php echo rawurlencode($_G['cache']['userstats']['newsetuser']); ?>" target="_blank" class="xi2"><?php echo $_G['cache']['userstats']['newsetuser'];?></a></em><?php } ?></p>
<div class="y">
<?php if(!empty($_G['setting']['pluginhooks']['index_nav_extra'])) echo $_G['setting']['pluginhooks']['index_nav_extra'];?>
<?php if($_G['uid']) { ?><a href="forum.php?mod=guide&amp;view=my" title="!my_posts!" class="xi2">!my_posts!</a><?php } if(!empty($_G['setting']['search']['forum']['status'])) { if($_G['uid']) { ?><span class="pipe">|</span><?php } ?><a href="forum.php?mod=guide&amp;view=new" title="!show_newthreads!" class="xi2">!show_newthreads!</a><?php } ?>
</div>
</div>
<?php } ?>
...
<div class="newimgbox">
<h4><span class="tit_newimg"></span>!latest_images!</h4>
...
<h4><span class="tit_subject"></span>!collection_lastthread!</h4>
...
<div class="replaybox">
<h4><span class="tit_replay"></span>!show_newthreads!</h4>
        <ul class="category_newlist">
...
<td valign="top" class="category_l3">
<div class="hottiebox">
<h4><span class="tit_hottie"></span>!hot_thread!</h4>
        <ul class="category_newlist">
...
<h4><span class="tit_goodtie"></span>!post_digest_thread!</h4>
...
<div class="bm_h cl">
<span class="o">
<img id="category_-1_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-1'];?>" title="!spread!" alt="!spread!" onclick="toggle_collapse('category_-1');" />
</span>
<h2><a href="forum.php?mod=collection&amp;op=my">!my_order_collection!</a></h2>
</div>
...
<dd><em>!forum_threads!: <?php echo dnumber($colletion['threadnum']); ?></em>, <em>!collection_commentnum!: <?php echo dnumber($colletion['commentnum']); ?></em></dd>
<dd>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $colletion['lastpost'];?>&amp;goto=lastpost#lastpost">!forum_lastpost!: <?php echo dgmdate($colletion[lastposttime]);?></a>
<?php } } else { ?>
!never!
<?php } ?>
</dd>
...
<div class="bm_h cl">
<span class="o">
<img id="category_0_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_0'];?>" title="!spread!" alt="!spread!" onclick="toggle_collapse('category_0');" />
</span>
<h2><a href="home.php?mod=space&amp;do=favorite&amp;type=forum">!forum_myfav!</a></h2>
</div>
...
<dt><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="!forum_todayposts!"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></dt>
<?php if(empty($forum['redirect'])) { ?><dd><em>!forum_threads!: <?php echo dnumber($forum['threads']); ?></em>, <em>!forum_posts!: <?php echo dnumber($forum['posts']); ?></em></dd><?php } ?>
<dd>
<?php if($forum['permission'] == 1) { ?>
!private_forum!
<?php } else { if($forum['redirect']) { ?>
<a href="<?php echo $forumurl;?>" class="xi2">!url_link!</a>
...
<?php } else { ?>
<a href="forum.php?mod=redirect&amp;tid=<?php echo $forum['lastpost']['tid'];?>&amp;goto=lastpost#lastpost">!forum_lastpost!: <?php echo $forum['lastpost']['dateline'];?></a>
<?php } } else { ?>
!never!
<?php } } ?>
</dd>
...
<td>
<h2><a href="<?php echo $forumurl;?>"<?php if($forum['redirect']) { ?> target="_blank"<?php } if($forum['extra']['namecolor']) { ?> style="color: <?php echo $forum['extra']['namecolor'];?>;"<?php } ?>><?php echo $forum['name'];?></a><?php if($forum['todayposts'] && !$forum['redirect']) { ?><em class="xw0 xi1" title="!forum_todayposts!"> (<?php echo $forum['todayposts'];?>)</em><?php } ?></h2>
<?php if($forum['description']) { ?><p class="xg2"><?php echo $forum['description'];?></p><?php } if($forum['subforums']) { ?><p>!forum_subforums!: <?php echo $forum['subforums'];?></p><?php } if($forum['moderators']) { ?><p>!forum_moderators!: <span class="xi2"><?php echo $forum['moderators'];?></span></p><?php } ?>
<?php if(!empty($_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]])) echo $_G['setting']['pluginhooks']['index_favforum_extra'][$forum[fid]];?>
</td>
<td class="fl_i">
...
<div class="bm_h cl">
<span class="o">
<img id="category_-2_img" src="<?php echo IMGDIR;?>/<?php echo $collapse['collapseimg_-2'];?>" title="!spread!" alt="!spread!" onclick="toggle_collapse('category_-2');" />
</span>
<h2><a href="forum.php?mod=collection">!recommend_collection!</a></h2>
</div>
...
<div class="bm_h">
<?php if($detailstatus) { ?>
<span class="o"><a href="forum.php?showoldetails=no#online" title="!spread!"><img src="<?php echo IMGDIR;?>/collapsed_no.gif" alt="!spread!" /></a></span>
<h3>
<strong><a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">!onlinemember!</a></strong>
<!--vot-->					<span class="xs1">- <strong><?php echo $onlinenum;?></strong> &nbsp;
<!--vot-->					( !index_members!: <strong><?php echo $membercount;?></strong>, !index_invisibles!: <strong><?php echo $invisiblecount;?></strong>,
<!--vot-->					!index_guests!: <strong><?php echo $guestcount;?></strong> )
<!--vot-->					- !index_mostonlines!: <strong><?php echo $onlineinfo['0'];?></strong> !on! <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } else { if(empty($_G['setting']['sessionclose'])) { ?>
<span class="o"><a href="forum.php?showoldetails=yes#online" title="!spread!"><img src="<?php echo IMGDIR;?>/collapsed_yes.gif" alt="!spread!" /></a></span>
<?php } ?>
<h3>
<strong>
...
!onlinemember!
<?php } else { ?>
<a href="home.php?mod=space&amp;do=friend&amp;view=online&amp;type=member">!onlinemember!</a>
<?php } ?>
</strong>
<span class="xs1">- !total! <strong><?php echo $onlinenum;?></strong> !onlines!
<?php if($membercount) { ?>- <strong><?php echo $membercount;?></strong> !index_members!,<strong><?php echo $guestcount;?></strong> !index_guests!<?php } ?>
- !index_mostonlines! <strong><?php echo $onlineinfo['0'];?></strong> !on! <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
<?php } ?>
</div>
...
<?php } } else { ?>
<li style="width: auto">!online_only_guests!</li>
<?php } ?>
</ul>
</dd>
<?php } ?>
