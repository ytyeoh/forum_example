...
0
|| checktplrefresh('./template/default/member/login.htm', './template/default/common/seccheck.htm', 1528648435, '1', './data/template/en_1_1_member_login.tpl.php', './template/default', 'member/login')
...
<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2">没有帐号？<a href="member.php?mod=<?php echo $_G['setting']['regname'];?>">注册帐号</a></a>
</span>
...
<!--vot-->						<td class="tipcol"><a href="member.php?mod=<?php echo $_G['setting']['regname'];?>">注册</a></td>
</tr>
</table>
</div>
<div class="rfm">
