...
0
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seditor.htm', 1529213485, '1', './data/template/zh_cn_1_1_forum_forumdisplay_fastpost.tpl.php', './template/default', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/forum/seccheck_post.htm', 1529213485, '1', './data/template/zh_cn_1_1_forum_forumdisplay_fastpost.tpl.php', './template/default', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/upload.htm', 1529213485, '1', './data/template/zh_cn_1_1_forum_forumdisplay_fastpost.tpl.php', './template/default', 'forum/forumdisplay_fastpost')
|| checktplrefresh('./template/default/forum/forumdisplay_fastpost.htm', './template/default/common/seccheck.htm', 1529213485, '1', './data/template/zh_cn_1_1_forum_forumdisplay_fastpost.tpl.php', './template/default', 'forum/forumdisplay_fastpost')
;?>
...
<option value="0" selected="selected">!select_thread_catgory!</option><?php if(is_array($_G['forum']['threadtypes']['types'])) foreach($_G['forum']['threadtypes']['types'] as $typeid => $name) { if(empty($_G['forum']['threadtypes']['moderators'][$typeid]) || $_G['forum']['ismoderator']) { ?>
...
<!--vot-->			<span>!comment_message1! <strong id="checklen">255</strong> !comment_message2!</span>
</div>
...
<a href="forum.php?mod=post&amp;action=newthread&amp;fid=<?php echo $_G['fid'];?>" onclick="switchAdvanceMode(this.href);doane(event);">!post_advancemode!</a>
...
<!--vot-->										!login_to_post! <a href="member.php?mod=logging&amp;action=login" onclick="showWindow('login', this.href)" class="xi2">!login!</a> | <a href="member.php?mod=<?php echo $_G['setting']['regname'];?>" class="xi2">!register!</a>
<?php } else { ?>
!connect_fill_profile_to_post!
<?php } } else { ?>
!no_permission_to_post!<a href="javascript:;" onclick="$('newspecial').onclick()" class="xi2">!click_to_show_reason!</a>
<?php } ?>
...
<label><input type="checkbox" name="adddynamic" class="pc" value="1" <?php if($_G['forum']['allowfeed'] && !$_G['tid'] && empty($_G['forum']['viewperm'])) { ?>checked="checked"<?php } ?> />!post_relay!</label>
<?php } ?>
</p>
</form>
</div>
