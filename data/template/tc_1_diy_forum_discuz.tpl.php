...
<?php if($cat['moderators']) { ?><span class="y">分區版主: <?php echo $cat['moderators'];?></span><?php } $caturl = !empty($cat['domain']) && !empty($_G['setting']['domain']['root']['forum']) ? $_G['scheme'].'://'.$cat['domain'].'.'.$_G['setting']['domain']['root']['forum'] : '';?><h2><a href="<?php if(!empty($caturl)) { ?><?php echo $caturl;?><?php } else { ?>forum.php?gid=<?php echo $cat['fid'];?><?php } ?>" style="<?php if($cat['extra']['namecolor']) { ?>color: <?php echo $cat['extra']['namecolor'];?>;<?php } ?>"><?php echo $cat['name'];?></a></h2>
</div>
...
<!--vot-->					( 會員: <strong><?php echo $membercount;?></strong>, 隱身: <strong><?php echo $invisiblecount;?></strong>,
<!--vot-->					遊客: <strong><?php echo $guestcount;?></strong> )
<!--vot-->					- 最高記錄是: <strong><?php echo $onlineinfo['0'];?></strong> 於 <strong><?php echo $onlineinfo['1'];?></strong>.</span>
</h3>
...
<?php if($membercount) { ?>- <strong><?php echo $membercount;?></strong> 會員,<strong><?php echo $guestcount;?></strong> 遊客<?php } ?>
