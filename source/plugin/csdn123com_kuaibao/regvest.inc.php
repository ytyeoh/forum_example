...
$server_url = 'action=plugins&operation=config&do=' . $pluginid . '&identifier=csdn123com_kuaibao&pmod=adminVest&subpmod=regvest&formhash=' . FORMHASH;
if ($_GET['formhash'] == FORMHASH && empty($_GET['adduser']) == false && $_GET['adduser'] == 'yes') {
	...
	{
		cpmsg("csdn123com_kuaibao:reg_err", '', "error");
	}
	...
	cpmsg("csdn123com_kuaibao:registered_successfully", $server_url, "succeed");
	...
	include template('csdn123com_kuaibao:regvest');
